...
<body>
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" ><a class="btn btn-success" id="Cadastrar"href="index.html" #pricing>Realizar nova doação</a></button>
      <button id="Cadastrar" name="Cadastrar" class="btn btn-danger" type="Submit" ><a class="btn btn-danger" id="Cadastrar"href="index.html" #pricing>Voltar ao inicio</a></button>
  </div>
</div>
  </footer>
