...
<body>
  ...
  <main id="main">
<form class="form-horizontal" method="POST" action="../controller/doadorController.php">
<fieldset>
<div class="panel panel-primary">
    <div class="panel-heading2">Cadastro de doador</div>
...
<div class="form-group">
  ...
  <div class="col-md-2">
    ...
    <div class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
      <input id="prependedtext2" name="prependedtext2" class="form-control" placeholder="XX XXXX-XXXX" type="text" maxlength="12"  pattern="\[0-9]{2}\ [0-9]{4,6}-[0-9]{3,4}$"
      OnKeyPress="formatar('## ####-####', this)">
    </div>
  </div>
 </div> 
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <div class="input-group">
      ...
      <input id="senha" name="senha" class="form-control" placeholder="dk@dim20" required="" type="text"> <!--pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"-->
    </div>
  </div>
</div>
...
<!--<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" ><a class="btn btn-success" id="Cadastrar" href="forms/cadDoador.php">Cadastrar</a></button>
