...
<body>
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-6">
            <div class="footer-info">
              ...
              <p class="pb-3">SEJA BEM-VINDO(A)</p>
  ...
  <div class="col-md-8">
    <button id="Cadastrar" name="Cadastrar" class="btn btn-success" type="Submit" ><a class="btn btn-success" id="Cadastrar"href="Login/index.html">Fazer login</a></button>
    <button id="Cancelar" name="Cancelar" class="btn btn-danger" type="Reset"><a class="btn btn-danger" id="Cancelar"href="index.html">Voltar ao inicio</a></button>
  </div>
</div>
  </footer>
